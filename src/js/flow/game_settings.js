...
export class Game {
    exit: Array<number>;
    size: Array<number>;
    mines: { x: Array<number>, y: Array<number> };
    minesX: Array<number>;
    minesY: Array<number>;
    start: Array<number>;
    ...
    constructor(size: Array<number> = [], exit: Array<number> = [], mines: { x: Array<number>, y: Array<number> } = {}, start: Array<number> = [], facing: number = 0) {
        //board
        this.exit = exit;
        this.size = size;
        this.mines = mines;
        ...
        //this binding
        (this: any).runActionList = this.runActionList.bind(this);
        (this: any).action = this.action.bind(this);
        (this: any).rotate = this.rotate.bind(this);
        (this: any).turnTheTurleNinetyDeg = this.turnTheTurleNinetyDeg.bind(this);
        (this: any).move = this.move.bind(this);
        (this: any).checkForExit = this.checkForExit.bind(this);
        (this: any).checkIfOutsideBounds = this.checkIfOutsideBounds.bind(this);
        (this: any).checkForMineOnXAxis = this.checkForMineOnXAxis.bind(this);
        (this: any).checkForMineOnYAxis = this.checkForMineOnYAxis.bind(this);
        (this: any).checkForMine = this.checkForMine.bind(this);
        (this: any).checkLocation = this.checkLocation.bind(this);
    }

    runActionList(arr: Array<string>): void {
        arr.forEach((item) => {
            this.action(item);
        });
    }

    action(choice: string): any {
